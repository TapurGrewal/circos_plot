...
mat = read.csv('C:/Users/grewa/Desktop/cancergen/deg.csv', row.names = 1)
...
mat1 = mat[genes, ]
df = cbind.data.frame(rownames(mat1), mat1[, c(1,2,3)])
...
RCircos.Heatmap.Plot(data, data.col = 4, track.num = 6, side = "in",
